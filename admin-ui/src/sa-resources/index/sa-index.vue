...
<template>
    <div class="sa-admin">
                ...
                <div class="nav-left-bottom">
                    <div class="menu-box-1">
                        <div class="menu-box-2">
                            <!-- 菜单 -->
                            <el-menu class="el-menu-style-1" :unique-opened="unique_opened" :default-active="default_active" :default-openeds="default_openeds" :collapse="is_fold" @select="selectMenu">
                ...
                <div class="nav-right-2">
                    ...
                    <div class="towards-middle" @dblclick="atOpen($event)">
                        ...
                        <div class="tab-title-box" :style="{left: scrollX + 'px'}" @dblclick.stop="">
                            <div v-for="tab in tabList" :key="tab.id" :id=" 'tab-' + tab.id " class="tab-title" :class=" (tab == nativeTab ? 'tab-native' : '') " @click="showTab(tab)" @contextmenu.prevent="right_showMenu(tab, $event)" draggable="true" @dragstart="is_drag = true; dragTab = tab" @dragend="is_drag = false;">
        ...
        <!-- dialog -->
        <el-dialog v-if="dialogTab" :title="dialogTab.title" :visible.sync="dialogTab.isShow" :width="dialogTab.way == 1 ? '100%' : '80%' " :before-close="dialogTab.beforeClose" :close-on-click-modal="false" :top="dialogTab.way == 1 ? '0px' : '10vh' " :fullscreen="dialogTab.way == 1" custom-class="full-dialog">
