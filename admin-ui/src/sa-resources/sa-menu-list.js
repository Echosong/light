...
[
	...
	{id:100, name:"独立", icon: 'el-icon-search', view: () => import('@/sa-view/home/swiper-list.vue')},
	{
		id: '3',
		name: '首页设置',
	...
	},
	{
		...
		info: '对用户列表、添加、统计等等...',
		childList: [
			{id: '5-2', name: '用户列表', view: () => userView },
			{id: '5-1', name: '部门列表', view: () => userView },

			//{id: '5-1', name: '角色列表', view: () => import('@/sa-view/role/role-add.vue'), params: {username: '王铁汉'} },
		],
