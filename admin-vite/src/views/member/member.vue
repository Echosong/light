                ...
                <div>
                    <el-form label-position="right" label-width="200" :model="formLabelAlign" ref="ruleFormRef"
                        ...
                        <el-form-item prop="usertype" label="用户类型">
                            <el-select :disabled="formLabelAlign.id ? true : false" v-model="formLabelAlign.usertype"
                                       placeholder="用户类型">
                        ...
                        <el-form-item prop="userattribute" label="用户所属">
                            <el-select :disabled="formLabelAlign.id ? true : false"
                                       v-model="formLabelAlign.userattribute" placeholder="用户所属">
                        ...
                        <el-form-item :rules="[
                            ...
                            <el-input :disabled="formLabelAlign.id ? true : false" v-model="formLabelAlign.username"
                                      placeholder="用户名"/>
                        </el-form-item>
                        ...
                        <el-form-item required label="所在城市">
                            <el-form-item style="margin-right: 20px;" prop="parentCityCode" :rules="[
                                {
                                    required: true, message: '省份不能为空', trigger: 'change'
                                },
                            ]">
                                <el-select :disabled="formLabelAlign.id ? true : false"
                                           v-model="formLabelAlign.parentCityCode" @change="changeFn(1)"
                                           placeholder="省">
                                    <el-option v-for="(item, index) of parentCity" :key="index" :label="item.citytitle"
                                               :value="item.citycode"/>
                                </el-select>
                            </el-form-item>
                            <el-form-item prop="cityscode" :rules="[
                                {
                                    required: true, message: '城市不能为空', trigger: 'change'
                                },
                            ]">
                                <el-select :disabled="formLabelAlign.id ? true : false"
                                           v-model="formLabelAlign.cityscode" placeholder="市">
                        ...
                        <el-form-item prop="qq" label="QQ">
                            <el-input v-model="formLabelAlign.qq" placeholder="QQ"/>
                        </el-form-item>
                        ...
                        <el-form-item prop="userlevelid" :rules="[
                            ...
                            <el-select v-model="formLabelAlign.userlevelid" placeholder="用户级别">
                                <el-option v-for="(item,index) of levelList" :key="index" :label="item.levelname"
                                           :value="item.id"/>
                            </el-select>
                        </el-form-item>
                        ...
                        <div v-if="formLabelAlign.usertype == 1">
                            ...
                            <el-form-item required label="所在城市">
                                <el-form-item style="margin-right: 20px;" prop="userCompanyDetails.parentCityCode"
                                    ...
                                    <el-select v-model="formLabelAlign.userCompanyDetails.parentCityCode"
                                        ...
                                        <el-option v-for="(item, index) of parentCity" :key="index"
                                                   :label="item.citytitle"
                                                   :value="item.citycode"/>
                                    </el-select>
                                </el-form-item>
                                <el-form-item prop="userCompanyDetails.cityscode" :rules="[
                                    {
                                        required: true, message: '城市不能为空', trigger: 'change'
                                    },
                                ]">
                                    <el-select v-model="formLabelAlign.userCompanyDetails.cityscode" placeholder="市">
                                        <el-option v-for="(item, index) of companyCitys" :key="index"
                                                   :label="item.citytitle"
                                                   :value="item.citycode"/>
                                    </el-select>
                                </el-form-item>
                            ...
                            <el-form-item prop="userCompanyDetails.contactperson" :rules="[
                                ...
                                <el-input v-model="formLabelAlign.userCompanyDetails.contactperson"
                                          placeholder="联系人"/>
                            </el-form-item>
                            ...
                            <el-form-item prop="userCompanyDetails.contacttelephone" :rules="[
                                ...
                                <el-input v-model="formLabelAlign.userCompanyDetails.contacttelephone"
                                          placeholder="联系电话"/>
                            </el-form-item>
                            ...
                            <el-form-item prop="userCompanyDetails.qq" label="qq">
                                <el-input v-model="formLabelAlign.userCompanyDetails.qq" placeholder="qq"/>
                            </el-form-item>
                            ...
                            <el-form-item prop="userCompanyDetails.companyinfo" label="公司简介">
                                <el-input type="textarea" :rows="5"
                                          v-model="formLabelAlign.userCompanyDetails.companyinfo"
                                          placeholder="公司简介"/>
                            </el-form-item>
                        </div>
                        <el-form-item>
