...
import {encryptByBase64} from "@/utils/encrypt";
            ...
            submit: () => {
                ...
                state.loginForm.validate(async valid => {
                    if (valid) {
                        ...
                        let data
                        try {
                            state.model.password = encryptByBase64(state.model.password)
                            console.log(state.model.password)
                        ...
                        useApp().initToken(data.tokenValue)
