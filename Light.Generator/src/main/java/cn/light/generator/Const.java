 ...
 * <p>create date: 2021-11-0410:38</p >
 *
 * @author : echosong
 * @version :1.0.0
 */
public class Const {
     ...
     * 根路径
     */
    public static String ROOT_PATH = "E:\\外包项目整理\\light轻巧之光\\light";

    /**
     * 静态魔板路径
     */
    public static String  TEMPLATE_PATH = "templates/auto";
     ...
     * 开启或者关闭数据库备注
     */
    public static   boolean UNCOMMENT = true;
